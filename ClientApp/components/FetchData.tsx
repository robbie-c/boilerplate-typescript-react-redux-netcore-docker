...
class FetchData extends React.Component<WeatherForecastProps, {}> {
    ...
    private renderForecastsTable() {
        return <table className='tab"table"           <thead>
                <tr>
                    <th>Date</th>
                    <th>Temp. (C)</th>
                    <th>Temp. (F)</th>
    ...
    private renderPagination() {
        ...
        return <p className='clearfix text"clearfix text-center" <Link className='btn btn-defau"btn btn-default pull-left"ta/${ prevStartDateIndex }`}>Previous</Link>
            <Link className='btn btn-default"btn btn-default pull-right"/${ nextStartDateIndex }`}>Next</Link>
